...
public class ContadorFrame extends JFrame {
    ...
    private JButton botaoSalvar, botaoEditar, botaoLimpar, botarApagar, botaoSair, botaoCotacao, botaoCalcular;
	...
	public ContadorFrame() throws SQLException {
        ...
        botaoCalcular = new JButton("Cotacao");
        ...
        modelo.addColumn("Valor da Cotacao");
        preencherTabela();
...
//             cont.setId(id);
//             cont.setValor(valor);
//        	ArrayList <Double> result = CotCalcular(valor);
